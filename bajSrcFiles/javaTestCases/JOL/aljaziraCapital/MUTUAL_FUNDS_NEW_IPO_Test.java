...
import javaMain.JOL.aljaziraCapital.MUTUAL_FUNDS_NEW_IPO;

public class MUTUAL_FUNDS_NEW_IPO_Test extends TestBase{
	

	@Test
	public void MutualFundsMarketInformation() {

		TCName = "JOL Mutual New IPO";
		...
		if(isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					MUTUAL_FUNDS_NEW_IPO.NEW_IPO(TCName,scenarioCount,dataset);
