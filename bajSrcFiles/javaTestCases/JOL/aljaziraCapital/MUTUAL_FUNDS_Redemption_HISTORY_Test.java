...
import javaMain.JOL.aljaziraCapital.MUTUAL_FUNDS_REDEMPTION_HISTORY;

public class MUTUAL_FUNDS_Redemption_HISTORY_Test extends TestBase{

	@Test
	public void MutualFundsRedemptionHistory() {

		TCName = "JOL Mutual Funds Redemption History";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				...
				MUTUAL_FUNDS_REDEMPTION_HISTORY.openMutualFundsRedemptionHistoryFunc(TCName,scenarioCount,dataset);
