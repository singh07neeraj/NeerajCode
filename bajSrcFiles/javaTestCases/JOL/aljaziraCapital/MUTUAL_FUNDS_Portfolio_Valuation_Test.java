...
import javaMain.JOL.aljaziraCapital.MUTUAL_FUNDS_PORTFOLIO_VALUATION;

public class MUTUAL_FUNDS_Portfolio_Valuation_Test extends TestBase {

	@SuppressWarnings("unused")
	@Test
	public void MutualFundsPortfolioEvaluation() {

		TCName = "JOL Mutual Funds Portfolio Valuation";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					MUTUAL_FUNDS_PORTFOLIO_VALUATION.openMutualFundsPortfolioValuationFunc(TCName, scenarioCount, dataset);
