...
import javaMain.JOL.aljaziraCapital.MUTUAL_FUNDS_RATE;

public class MUTUAL_FUNDS_Rate_Test extends TestBase {

	@Test
	public void MutualFundsRate() {

		TCName = "JOL Mutual Funds Rate";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					MUTUAL_FUNDS_RATE.mutualFundsRate(TCName, scenarioCount, dataset);
