...
import javaMain.JOL.aljaziraCapital.MUTUAL_FUNDS_IPORI_INQUIRY;

public class Mutual_Funds_IPORO_InquiryTest extends TestBase{
	

	@Test
	public void MutualFundsMarketInformation() {

		TCName = "JOL Mutual IPORI Inquiry";
		...
		if(isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					MUTUAL_FUNDS_IPORI_INQUIRY.IPORIInquiry(TCName,scenarioCount,dataset);
