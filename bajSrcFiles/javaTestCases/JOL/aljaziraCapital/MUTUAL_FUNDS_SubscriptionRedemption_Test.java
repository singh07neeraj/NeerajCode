...
import javaMain.JOL.aljaziraCapital.MUTUAL_FUNDS_Subscription;

public class MUTUAL_FUNDS_SubscriptionRedemption_Test extends TestBase {

	@Test  
	public void mutualFundsSubscriptionRedemption() {
		
		TCName = "JOL Mutual Funds Subscription-Redemption";
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					MUTUAL_FUNDS_Subscription.mutualFundsSubscription(TCName, scenarioCount, dataset);
