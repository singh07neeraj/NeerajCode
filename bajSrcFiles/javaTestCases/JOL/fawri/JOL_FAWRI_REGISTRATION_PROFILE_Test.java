...
public class JOL_FAWRI_REGISTRATION_PROFILE_Test extends TestBase {
	@Test
	public void JOL_FAWRI_REGISTRATION_PROFILE() {

		TCName = "JOL Fawri - Registration Profile";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.JOL.fawri.JOL_FAWRI_REGISTRATION_PROFILE.JOL_FAWRI_REGISTRATION_PROFILE_Func(TCName, scenarioCount, dataset);
