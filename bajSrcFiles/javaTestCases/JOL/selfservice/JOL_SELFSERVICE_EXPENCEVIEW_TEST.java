...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_EXPENCEVIEW_FUNC;

public class JOL_SELFSERVICE_EXPENCEVIEW_TEST extends TestBase

{

	@Test
	public void JOL_SELFSERVICE_EXPENCEVIEW() {

		TCName = "JOL Self Service-Experience View";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_EXPENCEVIEW_FUNC.Expenceview(TCName, scenarioCount, dataset);
