...
public class JOL_SELFSERVICE_FxRates extends TestBase

{
	...
	public void JOL_SELFSERVICE_MESSAGE_BOX() {
		...
		TCName = "JOL Self Service  FX Rates";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_MESSAGE_BOX_All_Functions.FXRates(TCName, scenarioCount, dataset);
