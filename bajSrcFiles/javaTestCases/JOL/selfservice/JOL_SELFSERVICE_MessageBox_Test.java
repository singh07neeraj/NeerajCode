...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_MESSAGE_BOX_All_Functions;


public class JOL_SELFSERVICE_MessageBox_Test extends TestBase

{
	
	@Test
	public void JOL_SELFSERVICE_MESSAGE_BOX() {
		
		TCName = "JOL Self Service Message Box";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				...
				JOL_SELFSERVICE_MESSAGE_BOX_All_Functions.MessageBox(TCName,scenarioCount,dataset);
