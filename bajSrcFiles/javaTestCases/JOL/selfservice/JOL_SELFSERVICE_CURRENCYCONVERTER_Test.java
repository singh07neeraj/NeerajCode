...
public class JOL_SELFSERVICE_CURRENCYCONVERTER_Test extends TestBase{
	...
	public void JOL_SELFSERVICE_CURRENCYCONVERTER() {
		...
		TCName = "JOL Self Service-Currency Convertor";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				Log.pass("<mark style='background-color: white; color: green;font-weight:bold'>" + TCName + " : Scenario -> " + scenarioCount + " has started." + "</mark>");
				 javaMain.JOL.selfservice.JOL_SELFSERVICE_CURRENCYCONVERTER.JOL_SELFSERVICE_CURRENCYCONVERTER_Func(TCName,scenarioCount,dataset);
