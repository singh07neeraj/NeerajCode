...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_ORDERSTATUS_FUNC;

public class JOL_SELFSERVICE_ORDERSTATUS_TEST extends TestBase

{
	
	@Test
	public void JOL_SELFSERVICE_ORDERSTATUS() {

		TCName = "JOL Self Service-Order Status";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				...
				JOL_SELFSERVICE_ORDERSTATUS_FUNC.OrderStatus(TCName,scenarioCount,dataset);
