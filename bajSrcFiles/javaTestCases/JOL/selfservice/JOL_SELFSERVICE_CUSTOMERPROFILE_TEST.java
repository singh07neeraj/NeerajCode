...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_CUSTOMERPROFILE_FUNC;

public class JOL_SELFSERVICE_CUSTOMERPROFILE_TEST extends TestBase

{

	@Test
	public void JOL_SELFSERVICE_CUSTOMERPROFILE() {

		TCName = "JOL Self Service-Customer Profile";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_CUSTOMERPROFILE_FUNC.CustomerViewProfile(TCName, scenarioCount, dataset);
