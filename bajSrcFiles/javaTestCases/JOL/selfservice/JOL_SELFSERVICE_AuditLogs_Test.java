...
public class JOL_SELFSERVICE_AuditLogs_Test extends TestBase

{
	...
	public void JOL_SELFSERVICE_MESSAGE_BOX_Audit() {
		...
		TCName = "JOL Self Service-Audit logs";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_MESSAGE_BOX_All_Functions.AuditLogs(TCName, scenarioCount, dataset);
