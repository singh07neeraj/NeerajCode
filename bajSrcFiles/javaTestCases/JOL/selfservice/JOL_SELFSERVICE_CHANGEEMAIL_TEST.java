...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_CHANGEEMAIL_FUNC;

public class JOL_SELFSERVICE_CHANGEEMAIL_TEST extends TestBase

{

	@Test
	public void JOL_SELFSERVICE_ChaneEmail() {

		TCName = "JOL Self Service-Change Email";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_CHANGEEMAIL_FUNC.changeemail(TCName, scenarioCount, dataset);
