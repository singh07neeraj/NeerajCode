...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_VIEWLIMIT_FUNC;

public class JOL_SELFSERVICE_VIEWLIMIT_TEST extends TestBase

{

	@Test
	public void JOL_SELFSERVICE_VIEWLIMIT() {

		TCName = "JOL Self Service-View Limit";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_VIEWLIMIT_FUNC.ViewLimit(TCName, scenarioCount, dataset);
