...
import javaMain.JOL.selfservice.JOL_SELFSERVICE_CONTACT_US_FUNC;

public class JOL_SELFSERVICE_CONTACT_US_TEST extends TestBase

{

	@Test
	public void JOL_SELFSERVICE_CONTACT_US() {

		TCName = "JOL Self Service-Contact Us";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_SELFSERVICE_CONTACT_US_FUNC.ContactUs(TCName, scenarioCount, dataset);
