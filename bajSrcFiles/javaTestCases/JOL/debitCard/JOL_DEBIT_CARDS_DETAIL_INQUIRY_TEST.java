...
public class JOL_DEBIT_CARDS_DETAIL_INQUIRY_TEST extends TestBase

{
	...
	public void JOL_DEBIT_CARDS_DETAIL_INQUIRY() {
		...
		TCName = "JOL Debit Cards-Detail Inquiry";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_DEBIT_CARDS_DETAIL_INQUIRY_FUNC.DebitCardDetails(TCName, scenarioCount, dataset);
