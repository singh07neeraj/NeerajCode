...
import javaMain.JOL.debitCard.JOL_DEBIT_CARDS_LINK_TO_OTHER_ACCOUNT_FUNC;

public class JOL_DEBIT_CARDS_LINK_TO_OTHER_ACCOUNT_TEST extends TestBase

{

	@SuppressWarnings("unused")
	@Test
	public void JOL_DEBIT_CARDS_DETAIL_INQUIRY() {

		TCName = "JOL Debit Cards-Link to other Account";
		extentSetUp();
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_DEBIT_CARDS_LINK_TO_OTHER_ACCOUNT_FUNC.LINK_TO_OTHER_ACCOUNT(TCName, scenarioCount, dataset);
