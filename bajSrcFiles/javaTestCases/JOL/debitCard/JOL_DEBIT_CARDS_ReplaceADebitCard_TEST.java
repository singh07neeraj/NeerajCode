...
import javaMain.JOL.debitCard.JOL_DEBIT_CARDS_ReplaceADebitCard_FUNC;

public class JOL_DEBIT_CARDS_ReplaceADebitCard_TEST extends TestBase

{

	@SuppressWarnings("unused")
	@Test
	public void JOL_DEBIT_CARDS_ReplaceADebitCard() {

		TCName = "JOL Debit Cards-Replace Debit Card";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_DEBIT_CARDS_ReplaceADebitCard_FUNC.ReplaceADebitCard(TCName, scenarioCount, dataset);
