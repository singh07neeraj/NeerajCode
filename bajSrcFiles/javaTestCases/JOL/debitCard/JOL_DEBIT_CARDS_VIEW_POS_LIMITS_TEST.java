...
import javaMain.JOL.debitCard.JOL_DEBIT_CARDS_VIEW_POS_LIMITS_FUNC;

public class JOL_DEBIT_CARDS_VIEW_POS_LIMITS_TEST extends TestBase

{
	...
	public void JOL_DEBIT_CARDS_DETAIL_INQUIRY() {
		...
		TCName = "JOL Debit Cards-View POS Limits";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_DEBIT_CARDS_VIEW_POS_LIMITS_FUNC.VIEWPOSLIMITS(TCName, scenarioCount, dataset);
