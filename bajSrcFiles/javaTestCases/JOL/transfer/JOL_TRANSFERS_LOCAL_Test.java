...
public class JOL_TRANSFERS_LOCAL_Test extends TestBase

{

	@Test
	public void JOL_TRANSFERS_LOCAL() {

		TCName = "JOL Transfers-Local";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.JOL.transfer.JOL_TRANSFERS_LOCAL.JOL_TRANSFERS_LOCAL_Functions(TCName, scenarioCount, dataset);
