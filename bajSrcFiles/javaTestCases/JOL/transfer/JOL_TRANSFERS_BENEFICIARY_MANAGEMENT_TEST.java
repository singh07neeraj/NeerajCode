...
import javaMain.JOL.transfer.JOL_TRANSFERS_BENEFICIARY_MANAGEMENT;

public class JOL_TRANSFERS_BENEFICIARY_MANAGEMENT_TEST extends TestBase {
	
	

	@Test
	public void JOL_TRANSFERS_BENEFICIARY_MANAGEMENT() {

		
		TCName = "JOL Transfers - Beneficiary Management";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_TRANSFERS_BENEFICIARY_MANAGEMENT.JOL_TRANSFERS_BENEFICIARY_MANAGEMENT_functions(TCName, scenarioCount, dataset);
