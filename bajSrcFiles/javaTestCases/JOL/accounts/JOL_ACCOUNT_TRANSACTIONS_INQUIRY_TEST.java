...
import javaMain.JOL.accounts.JOL_ACCOUNT_TRANSACTIONS_INQUIRY_FUNC;

public class JOL_ACCOUNT_TRANSACTIONS_INQUIRY_TEST extends TestBase

{

	@Test
	public void JOL_ACCOUNT_TRANSACTIONS_INQUIRY() {

		TCName = "JOL Account - Transactions Enquiry";
		extentSetUp();
		...
		if (isMasterClassRun) {
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_ACCOUNT_TRANSACTIONS_INQUIRY_FUNC.JOlTransacationInquiry(TCName, scenarioCount, dataset);
