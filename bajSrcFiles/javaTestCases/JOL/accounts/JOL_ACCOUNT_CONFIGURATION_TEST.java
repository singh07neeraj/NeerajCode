...
import javaMain.JOL.accounts.JOL_ACCOUNT_CONFIGURATION;


public class JOL_ACCOUNT_CONFIGURATION_TEST extends TestBase

{
	
	@Test
	public void JOL_ACCOUNT_CONFIGURATION() {

		TCName = "JOL Account Configuration";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				...
				JOL_ACCOUNT_CONFIGURATION.AccountConfiguration(TCName,scenarioCount,dataset);
