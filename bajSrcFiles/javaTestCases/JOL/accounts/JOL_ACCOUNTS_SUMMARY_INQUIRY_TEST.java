...
public class JOL_ACCOUNTS_SUMMARY_INQUIRY_TEST extends TestBase

{
	...
	public void JOL_ACCOUNTS_SUMMARY_INQUIRY() {
		...
		TCName = "JOL Account - Summary Inquiry";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_ACCOUNTS_SUMMARY_INQUIRY_FUNC.JolAccountsSummaryEnquiryFunction(TCName, scenarioCount, dataset);
