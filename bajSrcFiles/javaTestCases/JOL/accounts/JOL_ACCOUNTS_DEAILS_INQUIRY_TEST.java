...
import javaMain.JOL.accounts.JOL_ACCOUNTS_DEAILS_INQUIRY_FUNC;

public class JOL_ACCOUNTS_DEAILS_INQUIRY_TEST extends TestBase
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_ACCOUNTS_DEAILS_INQUIRY_FUNC.JolAccountDetails(TCName, scenarioCount, dataset);
