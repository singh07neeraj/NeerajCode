...
public class JOL_ACCOUNT_REQUEST_STEMENT_BYMAIL_TEST extends TestBase

{
	@Test
	public void JOL_ACCOUNT_REQUEST_STEMENT_BYMAIL() {

		TCName = "JOL Account - Request Statement By Mail";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_ACCOUNT_REQUEST_STEMENT_BYMAIL_FUNC.jolaccountemail(TCName, scenarioCount, dataset);
