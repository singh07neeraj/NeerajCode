...
import javaMain.JOL.accounts.JOL_ACCOUNT_OPEN_ADDITIONAL_ACCOUNT_FUNC;

public class JOL_ACCOUNT_OPEN_ADDITIONAL_ACCOUNT_TEST extends TestBase

{
	...
	public void JOL_ACCOUNT_OPEN_ADDITIONAL_ACCOUNT() {
		...
		TCName = "JOL Account - Open Additional Account";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_ACCOUNT_OPEN_ADDITIONAL_ACCOUNT_FUNC.OpenAccount(TCName, scenarioCount, dataset);
