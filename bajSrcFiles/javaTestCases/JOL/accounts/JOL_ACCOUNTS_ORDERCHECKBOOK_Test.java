...
public class JOL_ACCOUNTS_ORDERCHECKBOOK_Test extends TestBase {

	@Test
	public void JOL_ACCOUNTS_ORDERCHECKBOOK() {

		TCName = "JOL Account - OrderChechBook";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.JOL.accounts.JOL_ACCOUNTS_ORDERCHECKBOOK.JOL_ACCOUNTS_ORDERCHECKBOOK_Func(TCName, scenarioCount, dataset);
