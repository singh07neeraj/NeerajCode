...
public class Jol_CreditCards_PendingTransactions_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_PENDING_TRANSACTIONS() {

		TCName = "JOL Credit Cards-Pending Transactions";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_DETAIL_INQUIRY_FUNC.PendingTransactions(TCName, scenarioCount, dataset);
