...
import javaMain.JOL.creditcards.JOL_CREDIT_CARDS_CASH_TRANSFERS_FUNC;

public class Jol_CreditCards_PaymentHistory_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_PAYMENTHISTORY() {

		TCName = "JOL Credit Cards-Payment History";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_CASH_TRANSFERS_FUNC.CardPaymentHistory(TCName, scenarioCount, dataset);
