...
public class Jol_CreditCards_ActiveCreditCard_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_ACTIVE_CREDIT_CARD() {

		TCName = "JOL Credit Cards-Active Credit Card";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_Update_Online_TransactionsStatus_FUNC.ActivateCreditCard(TCName, scenarioCount, dataset);
