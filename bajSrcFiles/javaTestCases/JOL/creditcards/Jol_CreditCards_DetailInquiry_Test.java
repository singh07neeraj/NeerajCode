...
public class Jol_CreditCards_DetailInquiry_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_DETAIL_INQUIRY() {

		TCName = "JOL Credit Cards-Detail Inquiry";
		extentSetUp();
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_DETAIL_INQUIRY_FUNC.CreditCatdDetails(TCName, scenarioCount, dataset);
