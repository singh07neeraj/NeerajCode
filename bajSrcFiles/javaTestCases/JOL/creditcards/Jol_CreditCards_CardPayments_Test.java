...
public class Jol_CreditCards_CardPayments_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_CARDPAYMENTS() {
		
		 TCName ="JOL Credit Cards-Card Payments";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_DETAIL_INQUIRY_FUNC.CardPayments(TCName, scenarioCount, dataset);
