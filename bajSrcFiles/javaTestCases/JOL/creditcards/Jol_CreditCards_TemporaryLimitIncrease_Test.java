...
public class Jol_CreditCards_TemporaryLimitIncrease_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_TEMPORARY_LIMIT_INCREASE() {

		 TCName ="JOL Credit Cards-Temporary Limit Increase";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_CREDIT_CARDS_Update_Online_TransactionsStatus_FUNC.TemparyLimitInCrease(TCName, scenarioCount, dataset);
