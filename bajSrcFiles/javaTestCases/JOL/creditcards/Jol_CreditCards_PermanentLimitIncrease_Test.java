...
import javaMain.JOL.creditcards.JOL_CREDIT_CARDS_Permanent_LimitIncrease_FUNC;

public class Jol_CreditCards_PermanentLimitIncrease_Test extends TestBase

{

	
	@Test
	public void JOL_CREDIT_CARDS_Permanent_LimitIncrease() {

		
		 TCName ="JOL Credit Cards-Permanent Limitincrease";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					JOL_CREDIT_CARDS_Permanent_LimitIncrease_FUNC.PermanentLimitIncrease(TCName, scenarioCount, dataset);
