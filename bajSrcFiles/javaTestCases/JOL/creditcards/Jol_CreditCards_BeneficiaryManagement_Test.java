...
public class Jol_CreditCards_BeneficiaryManagement_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_BENEFICIARY_MANAGEMENT() {

		TCName = "JOL Credit Cards-Beneficiary Management";
		extentSetUp();
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_Update_Online_TransactionsStatus_FUNC.Beneficiary_Management(TCName, scenarioCount, dataset);
