...
public class Jol_CreditCards_CashTransfers_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_CASH_TRANSFERS() {

		TCName = "JOL Credit Cards-cash transfers";
		extentSetUp();
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_CASH_TRANSFERS_FUNC.CashTransfer(TCName, scenarioCount, dataset);
