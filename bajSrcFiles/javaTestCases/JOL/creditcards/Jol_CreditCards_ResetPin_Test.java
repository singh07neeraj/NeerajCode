...
public class Jol_CreditCards_ResetPin_Test extends TestBase

{

	@SuppressWarnings("unused")
	@Test
	public void JOL_CREDIT_CARDS_RESETPIN() {

		TCName = "JOL Credit Cards-Reset Pin";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_APPLY_NEWCREDITCARD_FUNC.ReSetPIN(TCName, scenarioCount, dataset);
