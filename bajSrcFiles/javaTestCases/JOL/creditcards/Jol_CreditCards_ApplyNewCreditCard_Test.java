...
import javaMain.JOL.creditcards.JOL_CREDIT_CARDS_APPLY_NEWCREDITCARD_FUNC;

public class Jol_CreditCards_ApplyNewCreditCard_Test extends TestBase

{

	@Test
	public void JOL_CREDIT_CARDS_APPLY_NEWCREDITCARD() {

		TCName = "JOL Credit Cards-Apply New Credit Card";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				try {
					...
					JOL_CREDIT_CARDS_APPLY_NEWCREDITCARD_FUNC.ApplyNewCreditCard(TCName, scenarioCount, dataset);
