...
public class JOL_GOVERNMENT_PAYMENTSREFUNDSHISTORY_TEST extends TestBase

{

	@Test
	public void JOL_GOVERNMENT_PAYMENTSREFUNDSHISTORY() {

		TCName = "JOL Government Payments Refund History";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.JOL.governmentServices.JOL_GOVERNMENT_BENEFICIARYMANAGEMENT_FUNC.PaymentsRefundsHistory(TCName, scenarioCount, dataset);
