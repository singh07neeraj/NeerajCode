...
public class JOL_GOVERNMENT_SERVICES_REFUND_TEST extends TestBase

{

	@Test
	public void JOL_GOVERNMENT_SERVICES_REFUND() {

		TCName = "JOL Government Services Refund";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.JOL.governmentServices.JOL_GOVERNMENT_SERVICES_REFUND_FUNC.reFund(TCName, scenarioCount, dataset);
