...
public class JOL_GOVERNMENT_ADDNEWBENEFICIARY_TEST extends TestBase

{

	@Test
	public void JOL_GOVERNMENT_ADDNEWBENEFICIARY() {

		TCName = "JOL Government AddBeneficiary";
		extentSetUp();
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.JOL.governmentServices.JOL_GOVERNMENT_SERVICES_REFUND_FUNC.AddNewBeneficiary(TCName, scenarioCount, dataset);
