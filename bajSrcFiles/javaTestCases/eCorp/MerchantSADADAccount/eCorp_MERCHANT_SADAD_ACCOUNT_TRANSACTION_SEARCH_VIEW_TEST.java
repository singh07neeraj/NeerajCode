...
import javaMain.eCorp.MerchantSADADAccount.eCorp_MERCHANT_SADAD_ACCOUNT_TRANSACTION_SEARCH_VIEW_FUNC;

public class eCorp_MERCHANT_SADAD_ACCOUNT_TRANSACTION_SEARCH_VIEW_TEST extends TestBase

{
	...
	public void PayrollFileTemplate() {
		...
		TCName = "eCorp Merchant SADAD Account-Transaction Search View";
		extentSetUp();
		...
		if (true) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					eCorp_MERCHANT_SADAD_ACCOUNT_TRANSACTION_SEARCH_VIEW_FUNC.TransactionSearchView(TCName, scenarioCount, dataset);
