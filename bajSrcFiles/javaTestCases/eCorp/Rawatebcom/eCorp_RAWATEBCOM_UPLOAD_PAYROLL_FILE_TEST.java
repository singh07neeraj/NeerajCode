...
import javaMain.eCorp.Rawatebcom.eCorp_RAWATEBCOM_UPLOAD_PAYROLL_FILE_FUNC;

public class eCorp_RAWATEBCOM_UPLOAD_PAYROLL_FILE_TEST extends TestBase

{

	@Test
	public void UploadFileTemplate() {

		TCName = "eCorp Rawatebcom-Upload Payroll File";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_RAWATEBCOM_UPLOAD_PAYROLL_FILE_FUNC.Uploadfile(TCName, scenarioCount, dataset);
