...
import javaMain.eCorp.Rawatebcom.eCorp_RAWATEBCOM_PAYROLL_FILE_VALIDATION_FUNC;

public class eCorp_RAWATEBCOM_PAYROLL_FILE_VALIDATION_TEST extends TestBase

{
	...
	public void PayrollFileTemplate() {
		...
		TCName = "eCorp Rawatebcom-Payroll File Validation";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_RAWATEBCOM_PAYROLL_FILE_VALIDATION_FUNC.PayrollFileValidation(TCName, scenarioCount, dataset);
