...
import javaMain.eCorp.Rawatebcom.eCorp_RAWATEBCOM_PAYROLL_RESULT_FILE_FUNC;

public class eCorp_RAWATEBCOM_PAYROLL_RESULT_FILE_TEST extends TestBase

{
	...
	public void PayrollFileTemplate() {
		...
		TCName = "eCorp Rawatebcom-Payroll Result File";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_RAWATEBCOM_PAYROLL_RESULT_FILE_FUNC.PayrollResultFile(TCName, scenarioCount, dataset);
