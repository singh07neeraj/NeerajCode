...
import javaMain.eCorp.Rawatebcom.eCorp_RAWATEBCOM_UPLOADED_PAYROLL_FILES_FUNC;

public class eCorp_RAWATEBCOM_UPLOADED_PAYROLL_FILES_TEST extends TestBase

{
	...
	public void PayrollFileTemplate() {
		...
		TCName = "eCorp Rawatebcom-Uploaded Payroll Files";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_RAWATEBCOM_UPLOADED_PAYROLL_FILES_FUNC.UploadedPayrollFiles(TCName, scenarioCount, dataset);
