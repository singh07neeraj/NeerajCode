...
public class eCorp_THRIFTSAVINGPLAN_VIEW_TRANSACTION_FILE_VALIDATION_TEST extends TestBase

{
	...
	public void ViewContributorFileTemplate() {
		...
		TCName = "eCorp Thrift Saving Plan-View Transaction File Validation";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					eCorp_THRIFTSAVINGPLAN_TRANSACTION_FILE_FUNC.ViewTransactionFileValidation(TCName, scenarioCount, dataset);
