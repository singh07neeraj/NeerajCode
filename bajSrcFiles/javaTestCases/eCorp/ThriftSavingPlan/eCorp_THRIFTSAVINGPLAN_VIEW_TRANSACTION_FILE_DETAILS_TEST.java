...
public class eCorp_THRIFTSAVINGPLAN_VIEW_TRANSACTION_FILE_DETAILS_TEST extends TestBase

{
	

	@Test
	public void ViewTransactionFileTemplate() {

		TCName = "eCorp Thrift Saving Plan-View Transaction File Details";
		extentSetUp();
		...
		if (true) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					eCorp_THRIFTSAVINGPLAN_TRANSACTION_FILE_FUNC.ViewTransactionFileDetails(TCName, scenarioCount, dataset);
