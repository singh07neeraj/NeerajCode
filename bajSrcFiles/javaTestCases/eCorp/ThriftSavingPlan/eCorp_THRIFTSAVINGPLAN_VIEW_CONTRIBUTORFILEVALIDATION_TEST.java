...
import javaMain.eCorp.ThriftSavingPlan.eCorp_THRIFTSAVINGPLAN_VIEW_FUNC;

public class eCorp_THRIFTSAVINGPLAN_VIEW_CONTRIBUTORFILEVALIDATION_TEST extends TestBase

{
	...
	public void ViewContributorFileTemplate() {
		...
		TCName = "eCorp Thrift Saving Plan-View Contributor File Validation";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					eCorp_THRIFTSAVINGPLAN_VIEW_FUNC.ViewContributorFileValidation(TCName, scenarioCount, dataset);
