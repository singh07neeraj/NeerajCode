...
import javaMain.eCorp.ThriftSavingPlan.eCorp_THRIFTSAVINGPLAN_VIEW_CONTRIBUTOR_FILE_TEMPLATE_FUNC;

public class eCorp_THRIFTSAVINGPLAN_VIEW_CONTRIBUTOR_FILE_TEMPLATE_TEST extends TestBase

{
	...
	public void ViewContributorFileTemplate() {
		...
		TCName = "eCorp Thrift Saving Plan-View Contributor File Template";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					eCorp_THRIFTSAVINGPLAN_VIEW_CONTRIBUTOR_FILE_TEMPLATE_FUNC.ViewContributorFileTemplate(TCName, scenarioCount, dataset);
