...
import javaMain.eCorp.PointOfSales.eCorp_POINTOFSALES_POSPENDINGREQUESTS_FUNC;

public class eCorp_POINTOFSALES_POSPENDINGREQUESTS_TEST extends TestBase

{
	...
	public void eCorp_GOVERNMENT_ADDNEWBENEFICIARY() {
		...
		TCName = "eCorp Point Of Sales-POS Pending Requests";
		extentSetUp();
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_POINTOFSALES_POSPENDINGREQUESTS_FUNC.POSPendingRequests(TCName,
