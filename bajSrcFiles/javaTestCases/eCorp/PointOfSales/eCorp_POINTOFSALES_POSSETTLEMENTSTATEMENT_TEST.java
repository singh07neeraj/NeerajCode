...
import javaMain.eCorp.PointOfSales.eCorp_POINTOFSALES_POSSETTLEMENTSTATEMENT_FUNC;

public class eCorp_POINTOFSALES_POSSETTLEMENTSTATEMENT_TEST extends TestBase

{
	...
	public void POSSettlementStatement () {
		...
		TCName = "eCorp Point Of Sales-POS Settlement Statement";
		extentSetUp();
		if (true) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_POINTOFSALES_POSSETTLEMENTSTATEMENT_FUNC.POSSETTLEMENTSTATEMENT(TCName,
