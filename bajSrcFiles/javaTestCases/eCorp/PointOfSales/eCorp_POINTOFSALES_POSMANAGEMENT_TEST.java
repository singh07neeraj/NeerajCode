...
import javaMain.eCorp.PointOfSales.eCorp_POINTOFSALES_POSMANAGEMENT_FUNC;

public class eCorp_POINTOFSALES_POSMANAGEMENT_TEST extends TestBase

{
	...
	public void POSSettlementStatement () {
		...
		TCName = "eCorp Point Of Sales-POS Management";
		extentSetUp();
		if (true) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					eCorp_POINTOFSALES_POSMANAGEMENT_FUNC.POSMANAGEMENT(TCName,
