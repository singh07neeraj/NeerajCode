...
public class eCorp_Transfers_Local_Test extends TestBase

{

	@Test
	public void eCosp_Transfers_Local() {

		TCName = "eCorp Transfers-Local";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.eCorp.transfer.eCorp_Transfers_Local.eCorp_Transfers_Functions(TCName, scenarioCount, dataset);
