...
public class eCorp_Transfers_WithinBaj_Test extends TestBase {

	@SuppressWarnings("unused")
	@Test
	public void eCorp_Transfers_WithinBaj() {

		TCName = "eCorp Transfers - Within Bank Aljazira";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.eCorp.transfer.eCorp_Transfers_WithinBaj.eCorp_Transfers_WithinBaj_Func(TCName, scenarioCount, dataset);
