...
import javaMain.eCorp.selfservice.eCorp_SELFSERVICE_ORDERSTATUS_FUNC;

public class eCorp_SELFSERVICE_ORDERSTATUS_TEST extends TestBase

{
	
	@Test
	public void eCorp_SELFSERVICE_ORDERSTATUS() {

		TCName = "eCorp Self Service-Order Status";
		extentSetUp();
		...
		if(true) {
			...
			try {
				eCorp_SELFSERVICE_ORDERSTATUS_FUNC.OrderStatus(TCName,scenarioCount,dataset);
