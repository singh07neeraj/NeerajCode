...
public class eCorp_SELFSERVICE_FxRates extends TestBase

{
	...
	public void JOL_SELFSERVICE_MESSAGE_BOX() {
		...
		TCName = "eCorp Self Service FXRates";
		extentSetUp();
		...
		if(true) {
			...
			try {
				eCorp_SELFSERVICE_MESSAGE_BOX_All_Functions.FXRates(TCName,scenarioCount,dataset);
