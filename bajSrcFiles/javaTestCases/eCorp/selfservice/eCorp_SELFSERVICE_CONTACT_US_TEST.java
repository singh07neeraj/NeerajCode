...
import javaMain.eCorp.selfservice.eCorp_SELFSERVICE_CONTACT_US_FUNC;

public class eCorp_SELFSERVICE_CONTACT_US_TEST extends TestBase

{
	...
	public void eCorp_SELFSERVICE_CONTACT_US() {
		...
		TCName = "eCorp Self Service-Contact Us";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <= RowCount(TCName); scenarioCount++) {
				...
				try {
					eCorp_SELFSERVICE_CONTACT_US_FUNC.ContactUs(TCName, scenarioCount, dataset);
