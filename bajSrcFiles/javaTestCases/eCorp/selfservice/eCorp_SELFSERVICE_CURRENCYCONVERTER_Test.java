...
import javaMain.eCorp.selfservice.eCorp_SELFSERVICE_CURRENCYCONVERTER;


public class eCorp_SELFSERVICE_CURRENCYCONVERTER_Test extends TestBase{


	
	@Test
	public void JOL_SELFSERVICE_CURRENCYCONVERTER() {

		TCName = "eCorp Self Service-Currency Convertor";
		extentSetUp();
		...
		if(true) {
			...
			try {
				eCorp_SELFSERVICE_CURRENCYCONVERTER.CURRENCYCONVERTER_Func(TCName,scenarioCount,dataset);
