...
import javaMain.eCorp.selfservice.eCorp_SELFSERVICE_ExpenseCategorization_FUNC;


public class eCorp_SELFSERVICE_ExpenseCategorization_Test extends TestBase

{
	...
	public void ExpenseCategorization_Test() {
		...
		TCName = "eCorp Self Service-Expense Categorization";
		extentSetUp();
		...
		if(true) {
			...
			try {
				eCorp_SELFSERVICE_ExpenseCategorization_FUNC.ExpenseCategorization_Test(TCName,scenarioCount,dataset);
