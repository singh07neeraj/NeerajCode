...
public class SMART_Fawri_BeneficiaryManagementTest extends TestBase{


	@Test
	public void SMART_Fawri_BeneficiaryManagement(){
		
		TCName = "Smart Fawri - beneficiary management";
		extentSetUp();
		...
		for (scenarioCount = 1; scenarioCount <= 1; scenarioCount++) {
			try {
				javaMain.smart.fawri.SMART_Fawri_BeneficiaryManagement.fawribeneficiarymanagement(TCName,scenarioCount,dataset);
