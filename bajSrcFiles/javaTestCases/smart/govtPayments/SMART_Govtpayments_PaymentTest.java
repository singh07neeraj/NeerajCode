...
public class SMART_Govtpayments_PaymentTest extends TestBase{
	

	@Test
	public void SMART_Govtpayments_Payment(){
		
		TCName = "Smart GovtPayments - Payment";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				javaMain.smart.govtPayments.SMART_Govtpayments_Payment.Govtpayments_Payment(TCName,scenarioCount,dataset);
