...
public class SMART_Govtpayments_PaymentRefundHistoryTest extends TestBase{
	

	@Test
	public void SMART_Govtpayments_PaymentRefundHistory(){
		
		TCName = "Smart GovtPayments - Payment Refund History";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				javaMain.smart.govtPayments.SMART_Govtpayments_PaymentRefundHistory.Govtpayments_PaymentRefundHistory(TCName,scenarioCount,dataset);
