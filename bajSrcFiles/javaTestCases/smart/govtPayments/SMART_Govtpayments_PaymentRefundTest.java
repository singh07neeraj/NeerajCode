...
public class SMART_Govtpayments_PaymentRefundTest extends TestBase{
	

	@Test
	public void SMART_Govtpayments_PaymentRefund(){
		
		TCName = "Smart GovtPayments - Payment Refund";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				javaMain.smart.govtPayments.SMART_Govtpayments_PaymentRefund.Govtpayments_PaymentRefund(TCName,scenarioCount,dataset);
