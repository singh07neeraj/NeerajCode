...
public class SMART_Govtpayments_BeneficiaryMgmtTest extends TestBase{
	

	@Test
	public void SMART_Govtpayments_BeneficiaryMgmt(){
		
		TCName = "Smart GovtPayments - Beneficiary Management";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				javaMain.smart.govtPayments.SMART_Govtpayments_BeneficiaryMgmt.Govtpayments_BeneficiaryMgmt(TCName,scenarioCount,dataset);
