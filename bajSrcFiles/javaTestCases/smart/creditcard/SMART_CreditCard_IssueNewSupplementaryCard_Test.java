...
public class SMART_CreditCard_IssueNewSupplementaryCard_Test extends TestBase{


	@Test
	public void RequestaTemporaryLimitIncrease(){
		
		TCName = "Smart Credit Cards - Issue New Supplementary Card";
		extentSetUp();
		...
		if(isMasterClassRun) {
			...
			try {
				javaMain.smart.creditcard.SMART_CreditCard_IssueNewSupplementaryCard_Func.IssueNewSupplementaryCard(TCName,scenarioCount,dataset);
