...
public class SMART_DebitCard_UpdatePOSLimits_Test extends TestBase {

	@Test
	public void UpdatePOSLimits() {

		TCName = "Smart Debit Cards - UpdatePOSLimits";
		extentSetUp();
		...
		if (isMasterClassRun) {
			...
			for (scenarioCount = 1; scenarioCount <=RowCount(TCName); scenarioCount++) {
				...
				try {
					...
					javaMain.smart.debitCard.SMART_DebitCard_UpdatePOSLimits_Func.UpdatePOSLimits(TCName, scenarioCount, dataset);
