...
/**
 * Library name: BAJ_General_GetTCsCount
 * description: get TCs count from the DB like by service ID.
...
public class BAJ_General_GetJOLTCsCount {

	// private static final String DBResultArray = null;
	String[] DBResultArray1 = null;

	public int BAJ_General_GetJOLTCsCountByModule(String Module) {
		...
		try {
			...
			String url = "jdbc:sqlserver://BLRRIDGWD22231\\SQLEXPRESS;databaseName=ALOKTEST;integratedSecurity=true";
			...
			if (Module.equalsIgnoreCase("ALL")) {
				...
				Module = " where Module_Name = '" + Module + "'";
