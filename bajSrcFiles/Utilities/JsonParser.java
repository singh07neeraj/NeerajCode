 ...
 * {
 * 
 * if(json instanceof JSONObject) return _jsonToMap_((JSONObject)json) ;
 * 
 * else if (json instanceof String) { JSONObject jsonObject = new
 * JSONObject((String)json) ; return _jsonToMap_(jsonObject) ; } return null ; }
 * 
 * 
 * private static Map<String, Object> _jsonToMap_(JSONObject json) throws
 * JSONException { Map<String, Object> retMap = new HashMap<String, Object>();
 * 
 * if(json != JSONObject.NULL) { retMap = toMap(json); } return retMap; }
 * 
 * 
 * private static Map<String, Object> toMap(JSONObject object) throws
 ...
 * array.length(); i++) { Object value = array.get(i); if(value instanceof
 * JSONArray) { value = toList((JSONArray) value); }
 * 
 * else if(value instanceof JSONObject) { value = toMap((JSONObject) value); }
