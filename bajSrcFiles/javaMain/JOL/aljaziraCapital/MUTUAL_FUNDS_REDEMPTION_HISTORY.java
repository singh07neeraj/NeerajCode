...
public class MUTUAL_FUNDS_REDEMPTION_HISTORY extends TestBase {

	@SuppressWarnings("unused")
	public static boolean openMutualFundsRedemptionHistoryFunc(String TCName, int ScenarioCount, Object[] tCsDataset) throws Exception{
		...
		try {
			...
			OpenJOLMenues.openAljaziraCapitalMenu("RedemptionHistory");
