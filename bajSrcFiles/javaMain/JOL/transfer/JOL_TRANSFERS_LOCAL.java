...
public class JOL_TRANSFERS_LOCAL extends TestBase {

	@SuppressWarnings("unused")
	public static boolean JOL_TRANSFERS_LOCAL_Functions(String TCName, int ScenarioCount, Object[] tCsDataset) throws Exception {
		...
		try {
			...
			OpenJOLMenues.openTransfersMenu("Local");
			...
			if (Integer.parseInt(AddAnotherTxn) > 0) {
				...
				// table.
				TransferModuleCommonFunctions.addAnotherTxnLocal(Integer.parseInt(AddAnotherTxn));
			}
			...
			if (Integer.parseInt(Proceed) == 1) {
				...
				Log.pass("Started cancelling the transaction as required..");
			...
			try {
				...
				Log.fail(" Within BAJ transfer failed...Message:" + Utils.getTextNoException(By.xpath(getObj("Propval1", "failMessage", "Card"))));
				Utils.logFailImage("Transfer Result-Fail");
				throw e;
			}
