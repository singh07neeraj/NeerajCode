 ...
 * @author baj80000892
 */
public class eCorp_MERCHANT_SADAD_ACCOUNT_TRANSACTIONS_HISTORY_FUNC extends TestBase {

	public static Boolean TransactionsHistory  (String TCName, int ScenarioCount, Object[] tCsDataset) throws Exception {
		...
		try {
			...
			Utils.click(By.xpath(getObj("Propval1", "MerchantSADADAccount", "eCorp_MerchantSADADAccount_TransactionsHistory")),"Merchant SADAD Account");
			Utils.click(By.xpath(getObj("Propval1", "OnlinePayments", "eCorp_MerchantSADADAccount_TransactionsHistory")),"Online Payments");

			Utils.click(By.xpath(getObj("Propval1", "TransactionsHistory", "eCorp_MerchantSADADAccount_TransactionsHistory")),"TransactionsHistory");

			// Verify landing page
			String LandPage = Utils
					.getText(By.xpath(getObj("Propval1", "LandPage", "eCorp_MerchantSADADAccount_TransactionsHistory")));

			Log.pass("Landed Page is  :" + LandPage);

			Utils.sendKeys(By.xpath(getObj("Propval1", "transactionId", "eCorp_MerchantSADADAccount_TransactionsHistory")), ReadTestData(TCName, "TransactionID")  , "transactionId");
			
			Utils.sendKeys(By.xpath(getObj("Propval1", "merchantReference", "eCorp_MerchantSADADAccount_TransactionsHistory")), ReadTestData(TCName, "MerchantReferenceNumber")  , "merchant Reference");

		

			Utils.sendKeys(By.xpath(getObj("Propval1", "bankReference", "eCorp_MerchantSADADAccount_TransactionsHistory")), ReadTestData(TCName, "BankReferenceNumber")  , "bank Reference");
			
			Utils.clickDropdownAndSendValue(
					By.xpath(getObj("Propval1", "DateFromDropDown", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					By.xpath(getObj("Propval1", "DateFrom", "eCorp_MerchantSADADAccount_TransactionsHistory")),ReadTestData(TCName, "StartDate")   ,
					"Start Date");
			
			Utils.clickDropdownAndSendValue(
					By.xpath(getObj("Propval1", "DateToDropDown", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					By.xpath(getObj("Propval1", "DateTo", "eCorp_MerchantSADADAccount_TransactionsHistory")),ReadTestData(TCName, "EndDate")   ,
					"End Date");
			
			Utils.clickDropdownAndSendValue(
					By.xpath(getObj("Propval1", "transactionStatusDropDown", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					By.xpath(getObj("Propval1", "transactionStatus", "eCorp_MerchantSADADAccount_TransactionsHistory")),ReadTestData(TCName, "Status")   ,
					"transaction Status");
			...
			if (isNegative.equalsIgnoreCase("true")) {
				...
				Utils.clickDropdownAndSendValue(
						By.xpath(getObj("Propval1", "transactionDropDown", "eCorp_MerchantSADADAccount_TransactionsHistory")),
						By.xpath(getObj("Propval1", "transactionType", "eCorp_MerchantSADADAccount_TransactionsHistory")), ReadTestData(TCName, "InvalidTransactionType")  ,
						"transaction Type");
				
				try {

					Assert.assertTrue(Utils.assertDisplayed(
							By.xpath(getObj("Propval1", "error", "eCorp_MerchantSADADAccount_TransactionsHistory")),"Error Message"));
			...
			Utils.click(By.xpath(getObj("Propval1", "Search", "eCorp_MerchantSADADAccount_TransactionsHistory")), "Search");
			Utils.wait(3);
	...
	public static boolean addFavSendEmailDownloadPdfNprintFuncBeneficiary(String Nickname) throws Exception {
		...
		try {
			...
			Utils.click(By.xpath(getObj("Propval1", "sendEmailIcon", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"Send Email Icon");
			Utils.sendKeys(
					By.xpath(getObj("Propval1", "sendEmailTo", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					Input.ReadTestData("MarketInfo", "toEmail"), "to email ");
			Utils.sendKeys(
					By.xpath(getObj("Propval1", "sendEmailCC", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					Input.ReadTestData("MarketInfo", "ccEmail"), "to CC email ");
			Utils.sendKeys(By.xpath(getObj("Propval1", "bccEmail", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					Input.ReadTestData("MarketInfo", "bccEmail"), "to BCC  email ");
			Utils.sendKeys(
					By.xpath(getObj("Propval1", "emailSubject", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					Input.ReadTestData("MarketInfo", "emailSubject"), "email Subject ");
			Utils.sendKeys(
					By.xpath(getObj("Propval1", "sendEMailMsgBox", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					Input.ReadTestData("MarketInfo", "sendEMailMsgBox"), "Mail Body ");

			Utils.click(
					By.xpath(getObj("Propval1", "cancelemailBtnEle", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"Cancel Email Button");
			Utils.wait(5);
			Utils.click(By.xpath(getObj("Propval1", "sendEmailIcon", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"Send Email Icon");
			...
			Utils.sendKeys(
					...
					Input.ReadTestData("MarketInfo", "sendEMailMsgBox"), "Mail Body ");
			Utils.wait(5);
			Utils.click(By.xpath(getObj("Propval1", "sendBtnEle", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"Send Email Button");
			Utils.waitForInVisibilityOfEle(
					By.xpath(getObj("Propval1", "WaitingElements", "eCorp_MerchantSADADAccount_TransactionsHistory")));
			Utils.pressEnter();
			Utils.wait(2);
			...
			Utils.click(
					By.xpath(getObj("Propval1", "pdfDownloadIcon", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"pdf download");
			Utils.wait(3);
			...
			Utils.click(
					By.xpath(getObj("Propval1", "excelDownloadIcon", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"Excel Download");
			Utils.wait(3);
			// Utils.enterOTPAndProceed();
			Utils.moveToElement(By.id("logo"));
			...
			Utils.wait(6);
			driver.navigate().refresh();
			Utils.click(By.xpath(getObj("Propval1", "printBtnIcon", "eCorp_MerchantSADADAccount_TransactionsHistory")),
					"Print Button");
