...
public class SMART_CreditCard_ApplyforaCreditCard_Func extends TestBase {
	...
	public static boolean ApplyforaCreditCard(String TCName, int ScenarioCount, Object[] tCsDataset) throws Exception {
		...
		try {
			...
			Utils.wait(2);
			Utils.click_Smart(By.xpath(getObj("Propval1", "ApplyforaCreditCard", "SMART_CreditCard_IssueNewSupplementaryCard")), "Apply for a Credit Card");
